...
#print('Softmax MOD3 test_error=', run_softmax_on_MNIST_mod3(temp_parameter=.5))
#print('Softmax MOD3 test_error=', run_softmax_on_MNIST_mod3(temp_parameter=1.0))
#print('Softmax MOD3 test_error=', run_softmax_on_MNIST_mod3(temp_parameter=2.0))
...
train_pca10 = project_onto_PC(train_x, pcs, n_components2, feature_means)
test_pca10 = project_onto_PC(test_x, pcs, n_components2, feature_means)
...
#
print("Test error with 10-dim PCA with cubic features:", test_error2)
